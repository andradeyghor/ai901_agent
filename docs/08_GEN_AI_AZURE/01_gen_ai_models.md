...
{
    Task: "Chat",
    Recommended model types: "GPT‑5.x chat, Claude Sonnet/Opus, Mistral‑Large‑3, DeepSeek V3.1, small language models (SLMs) like Phi‑4 or Llama",
    Model details: "Strong reasoning, conversation tuning, safety"
}
{
    Task: "Coding",
    Recommended model types: "GPT‑5.1‑codex, Claude‑Sonnet",
    Model details: "Support for complex agent flows"
}
{
    Task: "Summarization",
    Recommended model types: "GPT‑5.x reasoning models, Claude Opus/Sonnet",
    Model details: "Long-context, high-quality compression"
}
{
    Task: "Embeddings",
    Recommended model types: "text‑embedding‑3-small or other embedding models",
    Model details: "Built for semantic vector representations"
}
{
    Task: "Multimodal",
    Recommended model types: "Phi‑4‑multimodal‑instruct, GPT‑5.x chat multimodal, Mistral‑Large‑3",
    Model details: "Support for images, audio, and video in chat completions"
}
{
    Task: "Industry or domain-specific",
    Recommended model types: "Domain-tuned models in the catalog",
    Model details: "Applications specific to an industry such as finance, healthcare, legal"
}

Note: When the use case is well‑defined, instead of choosing a model from the model catalog, you may choose a Foundry tool. Foundry tools are powered by prebuilt models that provide predictable performance, built‑in compliance, and fast time‑to‑value without custom modeling.
...
Note:  token is the smallest unit of text or data that a generative AI model can process. Models break input into tokens—such as words, subwords, characters, or punctuation—so they can understand and generate language efficiently.
